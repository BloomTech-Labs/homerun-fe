		...
		<>
				...
				<div className='desktop:w-1/2'>
					<div className='flex justify-center mt-20 desktop:justify-start desktop:pl-10 desktop:mt-5'>
						<h1 className='w-full max-w-2xl text-3xl text-center phone: tablet:text-4xl desktop:text-5x desktop:text-left desktop:max-w-xl'>
							<span className='text-hive'>TidyHive</span> is a home organizational tool where members of a
							household can create, assign, and complete tasks. Turn your todos into todones with TidyHive
							today!
						</h1>
					</div>
			...
			<section className='flex justify-center px-20 mt-20 mb-24 desktop:m-40'>
				<h2 className='max-w-2xl text-2xl text-center tablet:text-3xl desktop:max-w-full desktop:px-16'>
					These are the main features that TidyHive has to offer. Keep your household organized and everyone
					on the same page by creating tasks and assigning members to those tasks. Often times a majority of
					the work will fall on a single member of a household - delegating work within a household is so
					important. This includes keeping children on track with their chores and schoolwork or
					extra-curricular activities! There are limitations to a child account. Their account can only be
